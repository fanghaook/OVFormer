...
from ovformer_video import add_ovformer_video_config
...
class Trainer(DefaultTrainer):
    ...
    def build_evaluator(cls, cfg, dataset_name, output_folder=None):
        ...
        return LVVISEvaluator_video(dataset_name, cfg, True, output_folder)
