...
from ovformer import add_ovformer_config
...
For OVFormer:
$ ./analyze_model.py--num-inputs 100 --tasks flop --config-file configs/lvis/ovformer_R50_bs8.yaml \\
    MODEL.WEIGHTS models/ovformer_r50_lvis.pth
"""
    )
    parser.add_argument(
        "--tasks",
